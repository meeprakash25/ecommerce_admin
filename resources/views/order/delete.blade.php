...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h6>Delete Order</h6></div>

                    <div class="card-body">
                        <div class="col-md-12">
                            Delete Order by client:
                            <p class="d-inline">{{strtoupper($name) }} with email <strong>{{ $email }} </strong></p>

                            {!! Form::open(['method'=>'DELETE', 'action'=>['OrderController@destroy', $id]]) !!}
                            {{  Form::hidden('url',URL::previous())  }}
                            <div class="form-group">
                                <a href="{{route('orders.index')}}" class="btn btn-outline-dark pull-right col-sm-3 m-1">Cancel</a>
                            </div>
