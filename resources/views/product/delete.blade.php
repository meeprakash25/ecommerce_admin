...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header"><h6>Dashboard</h6></div>

                    <div class="card-body">
                        Delete Product: <p class="d-inline">{{strtoupper($product_name)}}</p>

                        {!! Form::open(['method'=>'DELETE', 'action'=>['ProductController@destroy', $id]]) !!}
                        {{  Form::hidden('url',URL::previous())  }}
                        <div class="form-group">
                            <a href="{{route('products.index')}}" class="btn btn-outline-dark pull-right col-sm-3 m-1">Cancel</a>
                        </div>
